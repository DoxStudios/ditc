...
class Screen:
    ...
    def createCharacter(self):
        ...
        clear()
        playerClass = self.ClassManager.getClass(self.InputManager.getInput("Please Select A Class", ["1: Barabarian", "2: Archer", "3: Wizard"]))
    ...
    def loadCharacter(self):
        ...
        try:
            ...
            player = self.EntityManager.createPlayerEntity(saveData.get("name", characterName), saveData.get("health", 100), saveData.get("hunger", 100), saveData.get("sanity", 100), saveData.get("damage multipliers", {"melee": 1, "ranged": 1, "spell": 1}), saveData.get("added damage", 0), saveData.get("defense multipliers", {"melee": 1, "ranged": 1, "spell": 1}), saveData.get("current screen", "Catacombs Entrance"), saveData.get("can encounter", False), [], [], saveData.get("check points", []), saveData.get("mirrored", False))
            self.EntityManager.player = player
            for i in saveData.get("weapon inventory", []):
